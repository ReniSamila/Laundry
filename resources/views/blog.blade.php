      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/jaket2.jpg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Jaket</a></h3>
            <div>Rp.20.000 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/baju2.jpg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Baju</a></h3>
            <div>Rp.15.000 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/celana.jpg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Celana</a></h3>
            <div>Rp.20.000 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/boneka.jpeg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Boneka Kecil / Besar</a></h3>
            <div>Rp.30.000 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/bantal.jpg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Bantal / Guling</a></h3>
            <div>Rp.15.000  <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.html"><img src="{{ asset ('assets/frontend/jobboard/jobboard/images/selimut.jpg')}}" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.html" class="text-black">Selimut</a></h3>
